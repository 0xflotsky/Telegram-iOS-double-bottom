...
public struct ApplicationSpecificSharedDataKeys {
    ...
    public static let doubleBottomSettings: EngineDataBuffer = applicationSpecificSharedDataKey(ApplicationSpecificSharedDataKeyValues.doubleBottomSettings.rawValue)
}
